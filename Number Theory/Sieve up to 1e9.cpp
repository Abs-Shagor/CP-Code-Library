// optimal sieve
// takes 0.5s to calculate all primes for n = 1e9
#include<bits/stdc++.h>
using namespace std;

vector<int> optimal_sieve(const int N, const int Q = 17, const int L = 1 << 15) {
...
int32_t main() {
    ...
    // vector<int> primeList = optimal_sieve(1e9);
    // cout << primeList.size() << "\n";
    // for(int i=0 ; i<10 ; i++) cout << primeList[i] << "\n";
